...
from morphology import justroot
...
def parseSentence(text, pattern, tagtable=None, pairs=None, root=justroot):
...
def regexParse(pattern, tagged, tagtable=None, pairs=None, showprogress=False):
    if tagtable is None:
